...
export class RechazarReservaDto {
  ...
  static crear(objecto: ObjectoGenerico): RechazarReservaDto {
    const { reserva_id, restaurante_id, usuario_token_id, rol_usuario, usuario_rol_id, motivo_rechazo } = objecto
    ...
    if (!motivo_rechazo) throw CustomErrors.badRequest('El campo "motivo_rechazo" es requerido')
